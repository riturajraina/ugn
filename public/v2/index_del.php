...
<main role="main" class="mb-5">
						...
						<div class="oneadd-slider">
							<div id="information" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="ser-fly-com-logo"> <img class="img-fluid" src="images/sas.png" alt="First slide"> </div>
														...
														<div class="text-center"> <a href="flight-search-result.php" class="btn btn-primary btn-block">Compare all fare on oss</a> </div>
													</div>
												</div>
											</div>
											<div class="col-4">
												<div class="card up-effect"> <img class="card-img-top" src="images/c2.jpg" alt="Card image cap">
													<div class="card-body allbody_height">
														...
														<div class="text-center"> <a href="ugn-index.php" class="btn btn-primary btn-block">Know In Detail Steps</a> </div>
													</div>
												</div>
											</div>
											<div class="col-4">
												<div class="card up-effect"> <img class="card-img-top" src="images/c3.jpg" alt="Card image cap">
													<div class="card-body allbody_height">
														...
														<div class="text-center"> <a href="fashion-grid.php" class="btn btn-primary btn-block">Explore More Trending Styles</a> </div>
													</div>
												</div>
											</div>
										</div>
                                ...
                                <div class="ser-fly-com-logo"> <img class="img-fluid" src="images/sas.png" alt="First slide"> </div>
														...
														<div class="text-center"> <a href="#" class="btn btn-primary btn-block">Compare all fare on oss</a> </div>
													</div>
												</div>
											</div>
											<div class="col-4">
												<div class="card up-effect"> <img class="card-img-top" src="images/c2.jpg" alt="Card image cap">
													<div class="card-body allbody_height">
														...
														<div class="text-center"> <a href="#" class="btn btn-primary btn-block">Know In Detail Steps</a> </div>
													</div>
												</div>
											</div>
											<div class="col-4">
												<div class="card up-effect"> <img class="card-img-top" src="images/c3.jpg" alt="Card image cap">
													<div class="card-body allbody_height">
														...
														<div class="text-center"> <a href="#" class="btn btn-primary btn-block">Explore More Trending Styles</a> </div>
													</div>
												</div>
											</div>
										</div>
	...
	<!--add section start hear-->
			<div class="row">
				...
				<img class="second-slide img-fluid w-100" src="images/banner-1.jpg" alt="Second slide">
