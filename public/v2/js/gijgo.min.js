...
gj.widget = function() {
    ...
    function(a) {
        ...
        createMoveHandler: function(a) {
            return function(b) {
                var c, d, e, f, g, h;
                "true" === a.attr("data-draggable-dragging") && (c = a.mouseX(b), d = a.mouseY(b), g = a.attr("data-draggable-x"), h = a.attr("data-draggable-y"), g && h ? (e = a.data("horizontal") ? c - parseInt(g, 10) : 0, f = a.data("vertical") ? d - parseInt(h, 10) : 0, !1 !== gj.draggable.events.drag(a, e, f, c, d) && gj.draggable.methods.move(a, e, f)) : gj.draggable.events.start(a, c, d), a.attr("data-draggable-x", c), a.attr("data-draggable-y", d))
            }
        },
        move: function(a, b, c) {
            var d = a.get(0),
    ...
    function(a) {
        ...
        getRowById: function(a, b) {
            ...
            return c && (g = a.find('tbody > tr[data-position="' + c + '"]')), g
        },
    ...
    function(a) {
        ...
        edit: function(a) {
            var b, c = this.getById(a),
                d = gj.grid.methods.getRowById(this, a).find("td"),
                e = this.data("columns");
        ...
        cancel: function(a) {
            var b, c = (this.getById(a), gj.grid.methods.getRowById(this, a).find("td")),
                d = this.data("columns");
        ...
        private: {
            ...
            createResizeHandle: function(a, b, c) {
                return function(d, e) {
                    var f, g, h, i, j, k, l = parseInt(b.attr("width"), 10);
                    if (l || (l = b.outerWidth()), e && e.left && (j = l + e.left, c.width = j, b.attr("width", j), g = b[0].cellIndex, i = b[0].parentElement.children[g + 1], k = parseInt($(i).attr("width"), 10) - e.left, i.setAttribute("width", k), a.data().resizableColumns))
                        for (h = a[0].tBodies[0].children, f = 0; f < h.length; f++) h[f].cells[g].setAttribute("width", j), i = h[f].cells[g + 1], i.setAttribute("width", k)
                }
            }
        },
        public: {},
    ...
    function(a) {
        ...
        initialize: function(a) {
            ...
            if (gj.editor.methods.localization(e), a.addClass(e.style.wrapper), e.width && a.width(e.width), 0 === f.length && (a.wrapInner('<div data-role="body"></div>'), f = a.children('div[data-role="body"]')), f.attr("contenteditable", !0), f.on("mouseup keyup mouseout", function() {
                    d.updateToolbar(a, g)
                }), 0 === g.length) {
    ...
    function(a) {
        ...
        initialize: function(a) {
            ...
            c = "bootstrap" === d.uiLibrary ? $('<span class="input-group-addon">' + d.icons.rightIcon + "</span>") : "bootstrap4" === d.uiLibrary ? $('<span class="input-group-append"><span class="input-group-text">' + d.icons.rightIcon + "</span></span>") : $(d.icons.rightIcon), c.attr("role", "right-icon"), 0 === e.length ? (e = $('<div role="wrapper" />').addClass(d.style.wrapper), a.wrap(e)) : e.addClass(d.style.wrapper), e = a.parent('div[role="wrapper"]'), d.width && e.css("width", d.width), a.val(d.value).addClass(d.style.input).attr("role", "input"), d.fontSize && a.css("font-size", d.fontSize), c.on("click", function(b) {
                $("body").children('[role="calendar"][guid="' + a.attr("data-guid") + '"]').is(":visible") ? gj.datepicker.methods.hide(a) : gj.datepicker.methods.show(a)
            }), a.on("blur", function() {
                a.timeout = setTimeout(function() {
                    gj.datepicker.methods.hide(a)
                }, 500)
        ...
        }, c.disableDates = function(a) {}, c.disableWeekDay = function() {}, c.setMinDate = function() {}, c.setMaxDate = function() {}, $.extend(a, c), "true" !== a.attr("data-datepicker") && d.init.call(a, b), a
