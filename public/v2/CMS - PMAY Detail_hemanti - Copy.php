...
$content['breadcrump'] = ['Home', 'Registrations & Agreements', 'PRADHAN MANTRI AWAS YOJANA (Urban)'];
...
$content['header']['header_img_1'] = "images/ugn/Pmay_Logo.jpg";

//$content['header']['header_img_2'] = "https://design.mysabkuch.com/doss/v2/images/ugn/about-pmhome.jpg";

$content['header']['header_images'] = ["images/ugn/Pmay_Logo.jpg", "images/ugn/about-pmhome.jpg"];
...
$content['Tabs']['tab_1']['acc_2']['acc_para_text'] = '<img  src="https://i.ytimg.com/vi/aWXgqXynfPk/maxresdefault.jpg" alt="Image result for image search" style="margin-top: 0px;" width="576" height="324">';



$content['Tabs']['tab_1']['acc_3']['acc_title_text'] = 'Implementation model in PMAY – HOUSING FOR ALL';

$content['Tabs']['tab_1']['acc_3']['acc_para_text'] = 'This Mission has four components/verticals. PMAY Housing Scheme will work by providing central assistance to Urban Local Bodies (ULBs) as well as other employed agencies through States/UTs for:
<ul>
 	<li>Rehabilitation of existing slum dwellers using land as a resource through private participation</li>
 	<li>Credit Linked Subsidy</li>
 	<li>Affordable Housing in Partnership</li>
...
$content['Tabs']['tab_2']['acc_3']['acc_para_text'] = 'All 4041 statutory towns as per Census 2011 with focus on 500 Class I cities would be covered in three phases as follows:
<ul>
...
$content['sideImage'] = ['image', 'images/ugn/pmyojana-banner2.jpg', ''];
