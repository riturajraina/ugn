                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item">
                      <div class="row mr-0 ml-0">
                        <div class="col-3 pl-0 pr-0"> <a href="product_list.php">
                      ...
                      <div class="row mr-0 ml-0">
                        ...
                        <div class="col-3 pl-0 pr-0"> <a href="fashion-grid.php">
                          <div class="text-center border p-2 bdr-shadow">
                            <p>Women's Fashion</p>
					...
					<div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								...
								<div class="mt-1">
									<a href="compare.php" type="button"  class="btn btn-primary btn-lg btn-block">COMPARE</a>
								</div>
							</div>
							<div class="carousel-item">
								<a href="#">
