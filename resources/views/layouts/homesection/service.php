	...
	<div class="container">
		<h4 class="heading-font mb-3 mt-4">Find Best Deals & Book</h4>
		<div class="col bg-white border1 card">
			<div class="row ">
				<div class="col-2 pl-0 pr-0 flight">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					  <a class="nav-link py-2 px-1 active" id="v-pills-flights-tab" data-toggle="pill" href="#v-pills-flights" role="tab" aria-controls="v-pills-flights" aria-selected="true"><i class=""><img src="images/home_icon/s1.png" class="img-fluid" alt="Responsive image"></i> Flights</a>
					  
					  <a class="nav-link py-2 px-1" id="v-pills-Hotels-tab" data-toggle="pill" href="#v-pills-Hotels" role="tab" aria-controls="v-pills-Hotels" aria-selected="false"> <i class=""><img src="images/home_icon/s2.png" class="img-fluid" alt="Responsive image"></i>Hotels</a>
					  
					  <a class="nav-link py-2 px-1" id="v-pills-trains-tab" data-toggle="pill" href="#v-pills-trains" role="tab" aria-controls="v-pills-trains" aria-selected="false"><i class=""><img src="images/home_icon/s4.png" class="img-fluid" alt="Responsive image"></i>Trains</a>
					  
					  <a class="nav-link py-2 px-1" id="v-pills-Bus-tab" data-toggle="pill" href="#v-pills-Bus" role="tab" aria-controls="v-pills-Bus" aria-selected="false"><i class=""><img src="images/home_icon/s3.png" class="img-fluid" alt="Responsive image"></i>Bus</a>
					  
					  <a class="nav-link py-2 px-1" id="v-pills-Cabs-tab" data-toggle="pill" href="#v-pills-Cabs" role="tab" aria-controls="v-pills-Cabs" aria-selected="false"> <i class=""><img src="images/home_icon/s5.png" class="img-fluid" alt="Responsive image"></i>Cabs</a>
					  
					  <a class="nav-link py-2 px-1" id="v-pills-movies-tab" data-toggle="pill" href="#v-pills-movies" role="tab" aria-controls="v-pills-movies" aria-selected="false"> <i class=""><img src="images/home_icon/s7.png" class="img-fluid" alt="Responsive image"></i>Movies</a>
					  ...
					  <a class="nav-link py-2 px-1" id="v-pills-Food-tab" data-toggle="pill" href="#v-pills-Food" role="tab" aria-controls="v-pills-Food" aria-selected="false"> <i class=""><img src="images/home_icon/s6.png" class="img-fluid" alt="Responsive image"></i>Food Ordering</a>
					  
					  <a class="nav-link py-2 px-1" id="v-pills-Food-tab" data-toggle="pill" href="#v-pills-holiday" role="tab" aria-controls="v-pills-holiday" aria-selected="false"> <i class=""><img src="images/home_icon/s9.png" class="img-fluid" alt="Responsive image"></i>Holiday Packages</a>
					  ...
					  <!--<h5 class="mb-2 mt-4 text-center">Find Top Deals After Compare With Different Portals</h5>-->
						  ...
						  <h5 class="mb-2 mt-4 text-center">Find Top Deals after Comparing From 100+ Travel Portals</h5>
							...
							<div class="col">
										...
										<a href="flight-search-result.php" class="btn btn-secondry text-uppercase pl-3 pr-3 mb-0">Search  </a>
								</div>
								</div>
							</form>
						   <div class="row">
			...
			<div class="row border">
						...
						<div class="arrow_box"> OUR PARTNERS </div>
						</div>
						<div class="col-10 compare_partner pr-0 pl-0">
