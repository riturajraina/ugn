                                                ...
                                                <div class="col-9 pl-0">
                                                    <form class="mb-0 position-relative"> 	
                                                        ...
                                                        <div class="drag-form card text-left">
                                                            <?php require_once (env('VIEWSPATH') ."/layouts/homesection/form_search.php"); ?>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <div id="menu2" class="container tab-pane fade p-0"><br>
                                        <div class="search_h_b">
                                            <div class="row">
                                                <div class="col-3 pr-0">
                                                    <div class="dropdown drop_text">
                                                        <select name="ugnCategories" id="ugnCategories">
                                                        <?php
                                                            ...
                                                            echo $selectOptionsManager->showSelectOptions($categoryArray, null, 
                                                                    false);
                                                        ?>
                                                        </select>
                                                    </div>
