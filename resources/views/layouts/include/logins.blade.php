                ...
                <div class="row mx-0">
                    ...
                    <div class="col-7 p-3 login_content">
                        ...
                        <div class="pb-1">
                            <div class="row">
                                <div class="col w-50">
                                    <button type="button" class="btn facebook-btn btn-block">
                                        <i class="fa fa-facebook mr-1"></i> Sign in using Facebook
                                    </button>
                                </div>
                                <div class="col w-50">
                                    <button type="button" class="btn google-btn btn-block">
                                        <i class="fa fa-google-plus mr-1"></i> Sign in using Google
                                    </button>
                                </div>
                            </div>
                        </div>
