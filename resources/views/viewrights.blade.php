                ...
                rules = "none" cellspacing="2" cellpadding="4" rules="1">
                    ...
                    <tr>
                        <td colspan="5" width="100%" align="center">
                            <a href="/createright" target="_blank" title="Click here to create new right">
                                <strong>Create New Right</strong>
                            </a>
                        </td>
                    </tr>
                    ...
                    ?>          
                                <tr>
                                    ...
                                    <td>
                                        <a href="/editright/<?php echo $row['pk_admin_rights_id'];?>" target="_blank"
                                         title="Click here to edit this role">
                                            <strong><?php echo $row['admin_rights'];?></strong>
                                        </a>
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td colspan="5" align="center">
                            <?php
                                if (!empty($rightsList)) {
                                    echo $rightsList->appends($_REQUEST)->links();
                                }
                            ?>
                        </td>
                    </tr>
